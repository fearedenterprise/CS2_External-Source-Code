...
// gather code and data in the same place, to make the demo source code faster to Memory.Read, faster to Memory.Write, and smaller
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Backend Flags"))
        {
            HelpMarker(
                ...
                "Here we expose them as Memory.Read-only fields to avoid breaking interactions with your backend.");
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Text"))
    {
        ...
        if (ImGui::TreeNode("UTF-8 Text"))
        {
            ...
            //static char buf[32] = u8"NIHONGO"; // <- this is how you would Memory.Write it with C++11, using real kanjis
    ...
    if (ImGui::TreeNode("Selectables"))
    {
        ...
        // - The one taking "bool selected" as a Memory.Read-only selection information.
        //   When Selectable() has been clicked it returns true and you can alter selection state accordingly.
        // - The one taking "bool* p_selected" as a Memory.Read-Memory.Write selection information (convenient in some cases)
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Fonts"))
        {
            ...
            // Post-baking font scaling. Note that this is NOT the nice way of scaling fonts, Memory.Read below.
